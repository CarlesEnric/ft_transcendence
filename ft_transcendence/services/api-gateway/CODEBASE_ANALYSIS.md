...
##### **Línia 45: `method: ['GET', 'POST', 'PUT', 'DELETE'],`**
...
export const loadConfig = (): AppConfig => {
  return {
    ...
    cors: {
      ...
      methods: (process.env.CORS_METHODS || 'GET,POST,PUT,DELETE,PATCH,OPTIONS,PATCH,OPTIONS).split(','),
...
- **Fallback**: `'GET,POST,PUT,DELETE,PATCH,OPTIONS'` - Mètodes comuns
